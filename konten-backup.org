...
<section class="home-section home-full-height bg-dark bg-gradient" id="home" data-background="gambar/thumb_slide/<?=$slide['gambar']?>">
        ...
        <section class="module" id="contact">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        <form role="form" onsubmit="return showInput()" autocomplete="off">
                            <div class="form-group"><label class="sr-only" for="name">Name</label>
                            <input class="form-control" type="text" id="user_input" name="name" placeholder="Nama*" data-validation-required-message="Please enter your name." autocomplete="false" required>
                            ...
                            <select name="propinsi" class="form-control" id="user_provinsi" autocomplete="false" required>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kota" id="user_kota" class="form-control" autocomplete="false" required>
                            ...
                            <input class="form-control" type="number" id="user_goal" name="phone" placeholder="Hp*" data-validation-required-message="Please enter your phone." autocomplete="false" required>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" rows="7" id="user_pesan" name="message" placeholder="Pesanmu*" data-validation-required-message="Please enter your message."></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
        ...
        $("#user_provinsi").change(function(){
            var propinsi = $("#user_provinsi").val();
            $.ajax({
                url: "ambilkota.php",
    ...
    function showInput() {
            ...
            var b = document.getElementsByName('propinsi')[0].value;
            var b2 = document.getElementsByName('kota')[0].value;
            var b3 = document.getElementsByName('kec')[0].value;
            ...
            if (a == "") {
                ...
                alert("Mohon isi provinsi Anda dengan benar");
                return false;
            }
            else if(b2 == "") {
                ...
                alert("Mohon isi kecamatan Anda dengan benar");
                return false;
            }
            else if(c == "") {
                ...
                var strLink = wa + str + sap + a + enter + b + enter + b2 + enter + b3 + enter + c + enter + d;
