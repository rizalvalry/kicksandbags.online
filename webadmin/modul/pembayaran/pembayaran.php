...
?>
			...
			<div class="row">
				<div class="col-sm-8">
				<span style="font-size : 30px;">Pembayaan</span> beranda / pembayaran
				</div>
				<div class="col-sm-4">
					<p class="pull-right">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4><i class="glyphicon glyphicon-list"></i>Pembayaran</h4>
			...
			<div class="row">
				<div class="col-sm-10">
				<span style="font-size : 30px;">Pembayaran</span> beranda / tambah pembayaran
				</div>
				<div class="col-sm-2">
					<p class="pull-right">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4><i class="glyphicon glyphicon-pencil"></i>   Tambah Pembayaran</h4>
				...
				<div class="panel-body">	 
					<?php
						...
						if ( isset($_POST['tambah']) ){
							...
							if ( empty($rincian) ){
								...
								echo '<div class="alert alert-danger" role="alert" style="font-size : 12px; padding : 5px;">';
								echo '<button type="button" class="close" data-dismiss="alert">&times;</button>';
								echo '<strong>PERINGATAN!</strong> Transfer Minimum Harus Angka';
								echo '</div>';
					...
					?>
						<div class="form-group">
							<label class="control-label col-sm-4">Metode Pembayaran</label>
							<div class="col-sm-5">
								<input type="text"  class="form-control" value="<?php echo isset ($metode) ? $metode : ""; ?>" name="metode" placeholder="Metode Pembayaran" maxlength="100" required autofocus />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-4">Instruksi Transfer Pembayaran</label>
							<div class="col-sm-8">
								<textarea name="rincian" rows="10" id="tinymce_basic"><?php echo isset ($rincian) ? $rincian : ""; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-4">Transfer Minimum</label>
							<div class="col-sm-2">
								<input type="text"  class="form-control" value="<?php echo isset ($minimum) ? $minimum : ""; ?>" name="minimum" placeholder="Transfer Minimum" maxlength="11" required />
							</div>
						</div>
						<div class="form-group">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4><i class="glyphicon glyphicon-edit"></i>   Ubah Pembayaran</h4>
